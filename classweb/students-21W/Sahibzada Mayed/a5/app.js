		...
		template: `<div id="app">
			...
			<div id="controls">
				<div>
					...
					<button @click="enterInput">Ask a Math question?</button>
				</div>
				<div>
					<button @click="handleInput('Time to Eat!')">🍲</button>
					<button @click="handleInput('take a break')">It's time for a Study Break!</button>
				</div>
